...
import com.example.a10120766uts.Adapter.MusicAdapter;
import com.example.a10120766uts.Model.MusicModel;
import com.example.a10120766uts.R;

import java.util.ArrayList;

/*
    Dikerjakan pada tanggal : 16 Mei 2023
    Dibuat oleh :
    NIM   : 10120766
...
public class MusicVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MusicModel music1 = new MusicModel(R.drawable.musicplay, "Smells Like Teen Spirit", "Nirvana");
        ...
        MusicModel music5 = new MusicModel(R.drawable.musicplay, "Hysteria", "Muse");
        musicModel.add(music5);
        MusicModel music6 = new MusicModel(R.drawable.musicplay, "Don't Cry", "Guns N Roses");
        ...
        MusicModel music9 = new MusicModel(R.drawable.musicplay, "Seize The Day", "Avenged Sevenfold");
        musicModel.add(music9);
        MusicModel music10 = new MusicModel(R.drawable.musicplay, "Angie", "The Rolling Stones");
